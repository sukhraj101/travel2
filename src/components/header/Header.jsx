...
export default function Header() {
  return (
        <header id="header" className="u-header u-header--dark-nav-links-xl u-header--static-xl u-header--show-hide-xl" data-header-fix-moment="500" data-header-fix-effect="slide">
            <div className="u-header__section u-header__shadow-on-show-hide py-4 py-xl-0">
                <div className="bg-gray u-header__hide-content u-header__topbar u-header__topbar-lg border-bottom border-color-white">
                    <div className="container-fluid">
                        <div className="d-flex align-items-center">
                            <ul className="list-inline list-inline-dark u-header__topbar-nav-divider mb-0">
                                <li className="list-inline-item mr-0">
                                    <a href="tel:(000)999-898-999" className="u-header__navbar-link">(000) 999 - 898 -999</a>
                                </li>
                                <li className="list-inline-item mr-0">
                                    <a href="mailto:info@travila.com" className="u-header__navbar-link">info@travila.com</a>
                                </li>
                            </ul>
                            <div className="ml-auto d-flex align-items-center">
                                <ul className="list-inline mb-0 mr-2 pr-1">
                                    ...
                                    <li className="list-inline-item">
                                        <a className="btn btn-sm btn-icon btn-pill btn-soft-dark btn-bg-transparent transition-3d-hover" href="https://twitter.com/" target="_blank">
                                        <span className="fab fa-twitter btn-icon__inner"></span>
                                        </a>
                                    </li>
                                    <li className="list-inline-item">
                                        <a className="btn btn-sm btn-icon btn-pill btn-soft-dark btn-bg-transparent transition-3d-hover" href="https://www.instagram.com/" target="_blank">
                                        <span className="fab fa-instagram btn-icon__inner"></span>
                                        </a>
                                    </li>
                                    <li className="list-inline-item">
                                        <a className="btn btn-sm btn-icon btn-pill btn-soft-dark btn-bg-transparent transition-3d-hover" href="https://www.linkedin.com/" target="_blank">
                ...
                <div id="logoAndNav" className="container-fluid pt-xl-2 pb-xl-3 mb-xl-1">
                    <nav className="js-mega-menu navbar navbar-expand-xl u-header__navbar u-header__navbar--no-space">
                        ...
                        <Navbar/>
                        <div className="pl-4 ml-2 u-header__last-item-btn u-header__last-item-btn-lg">
                            <a className="btn btn-wide rounded-xs btn-primary transition-3d-hover" href="/register">
